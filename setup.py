...
setup(
    name="azul-plugin-android-parser",
    description="Plugin to parse android apps.",
    author="Azul",
    author_email="azul@asd.gov.au",
    url="https://www.asd.gov.au/",
    packages=["azul_plugin_android_parser"],
    include_package_data=True,
    python_requires=">=3.12",
    classifiers=[],
    entry_points={
        "console_scripts": [
            "azul-plugin-android-parser = azul_plugin_android_parser.main:main",
        ]
    },
